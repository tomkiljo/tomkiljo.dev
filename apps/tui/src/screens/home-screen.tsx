      ...
      <box flexDirection="row" flexGrow={1} gap={2}>
        <box flexDirection="column" flexGrow={2} gap={1}>
          ...
          <box flexDirection="column">
            ...
            <text>
              <span fg="magenta">◈</span> Full-spectrum developer and developer experience
              enthusiast
            </text>
            <text>
            ...
            <text>
              ...
              <Link href="https://nitor.com">https://nitor.com</Link>
            </text>
          </box>
          <box flexDirection="column">
            <text fg="cyan" paddingBottom={1}>
            ...
            <text>
              <span fg="blue">▣</span> Azure Developer Associate
            </text>
            <text>
              <span fg="blue">▣</span> Azure Administrator Associate
            </text>
            <text>
              <span fg="yellow">★</span> Azure Solutions Architect Expert
            </text>
            <text>
              <span fg="blue">▣</span> Azure AI Engineer Associate
            </text>
            <text>
              <span fg="magenta">✲</span> Azure Cosmos DB Developer Specialty
            </text>
          </box>
          <box flexDirection="column">
            <text fg="cyan" paddingBottom={1}>
            ...
            <text>
              <span fg="cyan">→ Github:</span> <Link href="https://github.com/tomkiljo" />
            </text>
            <text>
              <span fg="cyan">→ LinkedIn:</span> <Link href="https://linkedin.com/in/tomkiljo" />
            </text>
            <text>
              <span fg="cyan">→ Email:</span>{" "}
              <Link href="mailto:hi@tomkiljo.dev">hi@tomkiljo.dev</Link>
            </text>
          </box>
        </box>
        <box flexDirection="column" paddingX={2} paddingY={1} backgroundColor={PANEL_BG_COLOR}>
